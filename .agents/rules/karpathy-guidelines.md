...
description: Hard operational engineering protocol and behavioral invariants to prevent common LLM coding, auditing, peer-review, and over-engineering mistakes. Enforces receipts-first evidence, 3-tier MECE classification, complexity caps, primary source verification, and Diátaxis documentation structure across all projects.
license: MIT
---
